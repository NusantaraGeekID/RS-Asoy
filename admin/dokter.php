<div class="height-100 w-100" style="margin-top: 5rem !important;">
    <div class="card" style="border: 2px solid #F7B731;">
        <div class="card-header text-white fs-4" style="background-color: #F7B731;">Data Dokter</div>
        <div class="card-body">
        <button id="button_tambah" type="button" class="btn" style="width: 10rem;color: #fff;background-color: #FC5C65;">Tambah Dokter</button>
